    ...
    document={({ assets, children, scripts }) => (
      <html lang="id">
        <head>
          ...
          <meta name="description" content="AutoHIRA - Automated HIRADC System for Power Plant Operations. Sistem otomasi penyusunan formulir HIRA untuk pembangkit listrik." />
